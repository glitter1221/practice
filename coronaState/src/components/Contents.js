                ...
                datasets: [
                    {
                        ...
                        // data: arr.map 시 렌더링이 된 후 데이터가 들어오기 전에 map을 실행하여 오류가 남
